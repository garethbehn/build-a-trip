...
3. List any new Vercel environment variables required (e.g. ANTHROPIC_API_KEY, DUFFEL_API_KEY, LITEAPI_KEY, TTC_API_TOKEN) and remind the user to add + redeploy if needed.
